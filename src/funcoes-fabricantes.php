...
function inserirFabricante(PDO $conexao, string $nomeDoFabricante):void{
    ...
    try {
        ...
        /* bindValue() 
        permite vincular o valor existente no parâmetro nomeado (:nome) à consulta que será executada. É necessário indicar qual é o parâmetro (:nome), de onde vem o valor ($nomeDoFabricante) e de  que tipo ele é (PDO::PARAM_STR) */
